...
введения, трёх глав, заключения, источников и приложений с автоподстановкой
листингов кода.
"""
...
def main():
    # The defended document starts with a native Word table of contents on
    # printed page 4.  The marker is consumed by build_docx_final.py and is not
    # rendered as an ordinary Markdown heading.
    parts = ["СОДЕРЖАНИЕ"]
